            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header alert-success">
                        <h2 class="card-title"><b>List of all Feedbacks</b></h2>
...
if (isset($_POST['sendFeedback'])) {
    ...
    $smt = $conn->prepare("INSERT INTO notify (userid,message,status) VALUES (1,'You have Feedback',0)");
             $smt->execute();
    echo $send;
    if ($send) {
        echo "<script>alert('Feedback sent! We will get back to you');</script>";
        load($_SERVER['PHP_SELF'] . "?page=feedback");
    } else {
        echo "<script>alert('Feedback could not be sent! Try again!');</script>";
        load($_SERVER['PHP_SELF'] . "?page=feedback");
    }
}
