...
if (@$_GET['page'] == 'report' && isset($_GET['userid'])) {
    printReport($_GET['userid']);
    // echo "<script>window.location='admin.php'</script>";
}
                ...
                <div class="sidebar">
                    ...
                    <nav class="mt-2">
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                            ...
                            <li class="nav-item">
                                <a href="admin.php?page=turf" class="nav-link      <?php
...
<!--
                            <li class="nav-item">
                                <a href="admin.php?page=notification" class="nav-link      <?php
