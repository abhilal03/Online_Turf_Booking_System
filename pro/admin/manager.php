                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        ...
                                        <table style="width: 100%;" id="example1" style="align-items: stretch;"
                                            ...
                                            <tbody>
                                                <?php
                                                $row = connect()->query("SELECT * FROM register WHERE role='manager' ORDER BY userid DESC");
                                                if ($row->num_rows < 1)
                                                    echo "No Records Yet";
                                                $sn = 0;
                                                while ($fetch = $row->fetch_assoc()) {
                                                    ...
                                                    ?><tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a class="btn btn-success"href="uploads/<?php echo $fetch['proof']; ?>" target="_blank">View <i class="fa fa-book"></i></a>
                                                        </td>
                                                        <td>
